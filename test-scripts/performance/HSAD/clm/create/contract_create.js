...
export default async function () {
    ...
    try {
        ...
        const hasSearchInput = await page.locator(SELECTORS.BUSINESS.CLM.INPUT_TITLE_SEARCH).isVisible();
        ...
        // LC_008: 텍스트 입력 테스트
        const searchInput = page.locator(SELECTORS.BUSINESS.CLM.INPUT_TITLE_SEARCH);
